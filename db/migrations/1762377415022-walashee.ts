...
export class Walashee1762377415022 implements MigrationInterface {
    name = 'Walashee1762377415022'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`role\` \`role\` enum ('admin', 'customer', 'agent', 'delivery_company', 'driver', 'supplier', 'store_manager') NOT NULL DEFAULT 'customer'`);
